...
def run():
    ...
    test_embedded_dictvectorizer = loadPickle("test_2d_data_transformed")
    test_embedded_doc2vec = loadPickle("test_2d_data_vector")
    fig_num = 0
    ...
    #     gg.plot_cluster(title=algo, data=df_dictvectorizer, pad=30, plot_name=gv.prj_src_path + "generated_plots/" + algo,
    ...
    #     gg.plot_cluster(title=algo, data=df_doc2vec, pad=30,
    #                     plot_name=gv.prj_src_path + "generated_plots/" + algo,
    #                     fig_num=fig_num, l_col=3, hue=algo + "prediction")
    #
    # for algo in predicted_label["unsupervised"]:
    #     fig_num += 1
